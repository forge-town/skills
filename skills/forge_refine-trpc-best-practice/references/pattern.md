...
原始示例文件（位于 `forge_check-refine-trpc` 技能中）：
- 违规示例：[forge_check-refine-trpc/references/bad-example.ts](../forge_check-refine-trpc/references/bad-example.ts)
- 合规示例：[forge_check-refine-trpc/references/good-example.ts](../forge_check-refine-trpc/references/good-example.ts)
