...
此文档详细说明 forge_check-all-items 技能如何逐条执行最佳实践检查的完整流程。
...
const executionGroups = [
  ['forge_dao-best-practice', 'forge_service-best-practice'], // 组1
  ['forge_store-best-practice', 'forge_page-best-practice'],   // 组2
];
```
